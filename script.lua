...
if CheckFunc(writefile) and (CheckFunc(isfile) and not isfile('fisch/library.lua')) then
    writefile('fisch/library.lua', game:HttpGet('https://raw.githubusercontent.com/DeluxEngine/dsxsdasdefg/refs/heads/main/library.lua'))
end
if CheckFunc(loadfile) then
    library = loadfile('fisch/library.lua')()
else
    library = loadstring(game:HttpGet('https://raw.githubusercontent.com/DeluxEngine/dsxsdasdefg/refs/heads/main/library.lua'))()
end
